...
def coloring_optimization(coloring_instance: CSP) -> Tuple[int, bool]:
    """
    This function takes a coloring problem instance and returns an upper bound
    (if not the minimum) number of colors needed to color this graph.
    """
    ...
    return best_coloring_size, best_state
